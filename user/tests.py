...
class RegistrationTestCase(TestCase):
    ...
    """
    def setUp(self):
        self.sample_user = RegistrationProfile.objects.create_inactive_user(username='gloria',
                                                                            password='secret',
                                                                            email='gloria@example.com')
        self.expired_user = RegistrationProfile.objects.create_inactive_user(username='marvin',
                                                                             password='swordfish',
                                                                             email='marvo24@example.com')
